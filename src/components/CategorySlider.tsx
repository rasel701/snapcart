...
const CategorySlider = () => {
  ...
  return (
    <motion.div
      className="w-[90%] md:w-[80%] mx-auto mt-30 relative"
    ...
    >
      ...
      {showLeft && (
        <button
          className="absolute left-0 top-1/2 z-10 bg-white shadow-lg transition-all hover:bg-green-100 rounded-full w-10 h-10 flex items-center justify-center mr-1"
          onClick={() => scroll("left")}
        >
      ...
      {showRight && (
        <button
          className="absolute right-0 top-1/2 z-10 bg-white shadow-lg transition-all hover:bg-green-100 rounded-full w-10 h-10 flex items-center justify-center mr-1"
